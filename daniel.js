...
while (numer!=liczba) {
if (isNaN(numer) || numer == "") console.log("ale z Ciebie trampiszczał"); 
else console.log(numer>liczba ? "mniej": "wiecej");
...
if (odpowiedz=="nie") gramy=false
else if(odpowiedz=="tak") gramy= true 
else console.log("Jesteś waflem")
}
